...
void scheduler_init(void) {
  // TODO: DEV NOTE: Timer initialization completed by SH2 HAL (TIM owner).
  //  The custom (non-FreeRTOS) scheduler is enabled or disabled by a macro in
  //  configurations.h. As such the secondary device (SH2 BNO085/6 which also
  //  uses the same TIM (TIM2)
